	...
	<tr valign="top" bgcolor="#FFFFFF">
		...
		<td class="content" valign="top">
			...
			<div class="portlet">
				<div class="header">
					<div class="portlet-title">
						<h2 class="portlet-title">Item details</h2>
					</div>
				</div>
				<div class="chan-contain">
					<div class="body">
		...
		<td class="content" valign="top">
			<div class="portlet">
				<div class="header">
					<div class="portlet-title">
						<h2 class="portlet-title">Patron Details</h2>
					</div>
				</div>
				<div class="chan-contain">
					<div class="body">
			...
			<div class="portlet">
				<div class="header">
					<div class="portlet-title">
						<h2 class="portlet-title">Acquisition details</h2>
					</div>
				</div>
				<div class="chan-contain">
					<div class="body">
						<a class="portal_link" href="http://olereporting.soas.ac.uk/ReportServer/?%2fRepOLE%2fFundBalances&rs:Command=Render" target="_blank" title="Spend Breakdown by Account Number">Fund Balances</a>
						<br>
		...
		<td class="content" valign="top">
			<div class="portlet">
				<div class="header">
					<div class="portlet-title">
						<h2 class="portlet-title">Other Reports (Accurate to 11pm yesterday)</h2>
					</div>
				</div>
				<div class="chan-contain">
					<div class="body">
